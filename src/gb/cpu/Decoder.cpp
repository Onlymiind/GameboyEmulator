...
namespace gb::cpu {
    ...
    constexpr std::array<InstructionType, 8> g_bit_operations_ = {
        InstructionType::RLC,  InstructionType::RRC, InstructionType::RL,
        InstructionType::RR,   InstructionType::SLA, InstructionType::SRA,
        InstructionType::SWAP, InstructionType::SRL};

    static const std::unordered_map<uint8_t, InstructionType, column_hash,
                                    collideable_equal>
        g_columns_ = {
            {0x01, InstructionType::LD},  {0x02, InstructionType::LD},
    ...
    static const std::unordered_map<uint8_t, InstructionType>
        g_random_instructions_ = {
            {0x00, InstructionType::NOP},  {0x07, InstructionType::RLCA},
            {0x08, InstructionType::LD},   {0x0F, InstructionType::RRCA},

            {0x10, InstructionType::STOP}, {0x17, InstructionType::RLA},
            {0x18, InstructionType::JR},   {0x1F, InstructionType::RRA},

            {0x20, InstructionType::JR},   {0x27, InstructionType::DAA},
            {0x28, InstructionType::JR},   {0x2F, InstructionType::CPL},

            {0x30, InstructionType::JR},   {0x37, InstructionType::SCF},
            {0x38, InstructionType::JR},   {0x3F, InstructionType::CCF},
            {0xC0, InstructionType::RET},  {0xC2, InstructionType::JP},
            {0xC3, InstructionType::JP},   {0xC4, InstructionType::CALL},
            {0xC8, InstructionType::RET},  {0xC9, InstructionType::RET},
            {0xCA, InstructionType::JP},   {0xCC, InstructionType::CALL},
            {0xCD, InstructionType::CALL},

            {0xD0, InstructionType::RET},  {0xD2, InstructionType::JP},
            {0xD4, InstructionType::CALL}, {0xD8, InstructionType::RET},
            {0xD9, InstructionType::RETI}, {0xDA, InstructionType::JP},
            {0xDC, InstructionType::CALL},

            {0xE0, InstructionType::LD},   {0xE2, InstructionType::LD},
            {0xE8, InstructionType::ADD},  {0xE9, InstructionType::JP},
            {0xEA, InstructionType::LD},

            {0xF0, InstructionType::LD},   {0xF2, InstructionType::LD},
            {0xF3, InstructionType::DI},   {0xF8, InstructionType::LD},
            {0xF9, InstructionType::LD},   {0xFA, InstructionType::LD},
        ...
        {{0x08,
          {
              ...
              {},                 // Condition
              {ArgumentSource::Register, ArgumentType::Unsigned16,
               Registers::SP}, // Source
         ...
         {0xE0,
          {{},
           ...
           {ArgumentSource::Immediate, ArgumentType::Unsigned8,
            Registers::None},
           InstructionType::LD}},
         {0xF0,
          {{},
    ...
    void setALUInfo(opcode code, DecodedInstruction &instruction,
                    bool hasImmediate);
    ...
    void decodeRandomInstructions(opcode code,
    ...
    DecodedInstruction decodePrefixed(opcode code) {
        ...
        arg.src = arg.reg == Registers::HL ? ArgumentSource::Indirect
